                ...
                <div class="card-body with-nav">
                    <ul class="side-nav">
                        ...
                        {if $user->_is_admin}
                            ...
                            <!-- Users -->
                            <!-- Wines -->
                            <li {if $view == "wines"}class="active"{/if}>
                                <a href="#wines" data-toggle="collapse" {if $view == "wines"}aria-expanded="true"{/if}>
                                    <i class="fa fa-cocktail fa-fw mr10" style="color: #F44336"></i>{__("Wines")}
                                </a>
                                <div class='collapse {if $view == "wines"}show{/if}' id="wines">
                                    <ul>
                                        <li {if $view == "wines" && $sub_view == ""}class="active"{/if}>
                                            <a href="{$system['system_url']}/{$control_panel['url']}/wines">
                                                {__("List Wines")}
                                            </a>
                                        </li>
                                        <li {if $view == "wines" && $sub_view == "wineries"}class="active"{/if}>
                                            <a href="{$system['system_url']}/{$control_panel['url']}/wineries">
                                                {__("List Wineries")}
                                            </a>
                                        </li>
                                        <li {if $view == "regions"}class="active"{/if}>
                                            <a href="{$system['system_url']}/{$control_panel['url']}/regions">
                                                {__("List Regions")}
                                            </a>
                                        </li>
