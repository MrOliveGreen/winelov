...
<script src="{$system['system_url']}/includes/assets/js/jquery.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous" {if !$user->_logged_in}defer{/if}></script>
...
<script src="{$system['system_url']}/includes/assets/js/fluidplayer.min.js" {if !$user->_logged_in}defer{/if}></script>
<link rel="stylesheet" href="https://cdn.fluidplayer.com/v2/current/fluidplayer.min.css" type="text/css"/>


{*Javascript sources for top wine types menu*}
<script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>
<script src="{$system['system_url']}/includes/assets/js/plugins/swiper/swiper.min.js"></script>
<script src="{$system['system_url']}/includes/assets/js/plugins/parallax/parallax.min.js"></script>
<script src="{$system['system_url']}/includes/assets/js/plugins/star-rating-svg/star-rating-svg.js"></script>
{if $page =='explore'}
<script src="{$system['system_url']}/includes/assets/js/sngine/autocomplete.js"></script>
{/if}
<script src="{$system['system_url']}/includes/assets/js/sngine/mycustom.js"></script>
    ...
    {if $system['geolocation_enabled']}
        ...
        <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key={$system['geolocation_key']}{if $page == '_detail'}&callback=initMap{/if}"></script>
    {/if}
    <!-- Google Geocomplete -->
