<?php
/* Smarty version 3.1.34-dev-7, created on 2020-06-04 13:16:30
  from '/home/winelov/public_html/content/themes/default/templates/_detail.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ed8f42ef15a25_82608314',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'af5261461a4b50e570fcfd1a0db747a3a5ba75a7' => 
    array (
      0 => '/home/winelov/public_html/content/themes/default/templates/_detail.tpl',
      1 => 1591276523,
      2 => 'file',
    ),
  ),
...
function content_5ed8f42ef15a25_82608314 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="row">
            <div class="col-lg-9 detail-wine-description">
                <div class="col-lg-4 col-md-4 col-sm-4 detail-image">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['details']->value['image_URL'];?>
"/>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <div class="detail-winery black-letter"><p><?php echo $_smarty_tpl->tpl_vars['details']->value['winery'];?>
</p></div>
                    <div class="detail-name black-letter"><h3><?php echo $_smarty_tpl->tpl_vars['details']->value['name'];?>
</h3></div>
                    <?php if ($_smarty_tpl->tpl_vars['details']->value['region'] && $_smarty_tpl->tpl_vars['details']->value['country']) {?>
                    <div class="detail-region">
                        <img width="20px" height="20px" src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->tpl_vars['system']->value['theme'];?>
/images/flag/<?php echo $_smarty_tpl->tpl_vars['details']->value['country'];?>
-flag-round-xs.png">
                        <p class="detail-type black-letter">White wine</p>
                        <p>&nbsp;from</p>
                        <p class="detail-wine-region black-letter"><a>&nbsp;<?php echo $_smarty_tpl->tpl_vars['details']->value['region'];?>
</a></p>
                        <p>·</p>
                        <p class="detail-country black-letter"><a><?php echo $_smarty_tpl->tpl_vars['details']->value['country'];?>
</a></p>
                    </div>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['details']->value['rating']) {?>
                    <div class="detail-rating">
                        <div class="detail-rating-num black-letter"><?php echo $_smarty_tpl->tpl_vars['details']->value['rating'];?>
</div>
                        <div class="detail-rating-star" id="detail-rating-star<?php echo $_smarty_tpl->tpl_vars['details']->value['Id_item'];?>
" aria-valuetext="<?php echo $_smarty_tpl->tpl_vars['details']->value['rating'];?>
"></div>
                        <?php echo '<script'; ?>
>
                            var rating = $('#detail-rating-star<?php echo $_smarty_tpl->tpl_vars['details']->value["Id_item"];?>
').attr('aria-valuetext');
                            $('#detail-rating-star<?php echo $_smarty_tpl->tpl_vars['details']->value["Id_item"];?>
').rateit({
                                readonly: true,
                                step: 0.1,
                                value: rating,
...
>
                    ...
                    <div class="button-list">
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['winery']->value['Lat'] && $_smarty_tpl->tpl_vars['winery']->value['Lon']) {?>
                        <a href="https://www.google.com/maps/dir/?api=1<?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in && $_smarty_tpl->tpl_vars['user']->value->_data['user_latitude'] && $_smarty_tpl->tpl_vars['user']->value->_data['user_longitude']) {?>&orgin=<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_latitude'];?>
,<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_longitude'];
}?>&destination=<?php echo $_smarty_tpl->tpl_vars['winery']->value['Lat'];?>
,<?php echo $_smarty_tpl->tpl_vars['winery']->value['Lon'];?>
" target="_blank" class="btn-list btn-direction">
                        ...
                        <a class="btn-list btn-share action-btn" data-toggle="modal" data-url="posts/share.php?do=create&wine_id=<?php echo $_smarty_tpl->tpl_vars['details']->value['Id_item'];?>
">
            ...
            <?php if ($_smarty_tpl->tpl_vars['details']->value['price']) {?>
            <div class="col-lg-3 detail-wine-price">
                <div class="row">
                    <div class="detail-price black-letter"><h2>€<?php echo $_smarty_tpl->tpl_vars['details']->value['price'];?>
</h2></div>
                    <div>Price is per bottle</div>
                    <?php if ($_smarty_tpl->tpl_vars['details']->value['year']) {?>
                    <div class="detail-year">Vintage: <?php echo $_smarty_tpl->tpl_vars['details']->value['year'];?>
</div>
                    <?php }?>
                </div>
            </div>
        ...
        <div class="row wine-summary">
            ...
            <div class="col-lg-9 row">
                <div class="col-lg-6 summary-list">
                    ...
                    <div class="summary-content"><a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/winery/<?php echo $_smarty_tpl->tpl_vars['details']->value['winery'];?>
"><?php echo $_smarty_tpl->tpl_vars['details']->value['winery'];?>
</a></div>
                </div>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['grapes']) {?>
                <div class="col-lg-6 summary-list">
                    <div class="summary-title black-letter">Grapes</div>
                    <div class="summary-content"><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['details']->value['grapes'],';',',');?>
</div>
                </div>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['region']) {?>
                <div class="col-lg-6 summary-list">
                    <div class="summary-title black-letter">Region</div>
                    <div class="summary-content"><a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/region/<?php echo $_smarty_tpl->tpl_vars['details']->value['region'];?>
"><?php echo $_smarty_tpl->tpl_vars['details']->value['region'];?>
</a></div>
                </div>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['wine_style']) {?>
                <div class="col-lg-6 summary-list">
                    <div class="summary-title black-letter">Wine style</div>
                    <div class="summary-content"><?php echo $_smarty_tpl->tpl_vars['details']->value['wine_style'];?>
</div>
                </div>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['foodpairing']) {?>
                    <div class="col-lg-6 summary-list">
                        <div class="summary-title black-letter">Food pairing</div>
                        <div class="summary-content"><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['details']->value['foodpairing'],';',',');?>
</div>
                    </div>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['alcohol']) {?>
                    <div class="col-lg-6 summary-list">
                        <div class="summary-title black-letter">Alcohol</div>
                        <div class="summary-content"><?php echo $_smarty_tpl->tpl_vars['details']->value['alcohol'];?>
</div>
                    </div>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['allergy']) {?>
                    <div class="col-lg-6 summary-list">
                        <div class="summary-title black-letter">Allergy</div>
                        <div class="summary-content"><?php echo $_smarty_tpl->tpl_vars['details']->value['allergy'];?>
</div>
                    </div>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['wine_seo']) {?>
                    <div class="col-lg-6 summary-list">
                        <div class="summary-title black-letter">Wine SEO</div>
                        <div class="summary-content"><?php echo $_smarty_tpl->tpl_vars['details']->value['wine_seo'];?>
</div>
                    </div>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['details']->value['winery_seo']) {?>
                    <div class="col-lg-6 summary-list">
                        <div class="summary-title black-letter">Winery SEO</div>
                        <div class="summary-content"><?php echo $_smarty_tpl->tpl_vars['details']->value['winery_seo'];?>
</div>
                    </div>
                <?php }?>
            </div>
    ...
    <div class="container bottom-border">
        <div class="row about-winery">
            <div class="col-lg-12 about-winery-title black-letter">
                <h2>About <?php echo $_smarty_tpl->tpl_vars['winery']->value['Name'];?>
</h2>
            </div>
...
-flag-round-xs.png">
                    <p>Located in</p>
                    <p class="black-letter"><a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/region/<?php echo $_smarty_tpl->tpl_vars['details']->value['region'];?>
">&nbsp;<?php echo $_smarty_tpl->tpl_vars['details']->value['region'];?>
</a></p>
                    <p>·</p>
                    <p class="black-letter"><a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/country/<?php echo $_smarty_tpl->tpl_vars['details']->value['country'];?>
"><?php echo $_smarty_tpl->tpl_vars['details']->value['country'];?>
</a></p>
                </div>
                <?php }?>
            </div>
...
>
        function initMap() {
        var mapProp= {
            center:new google.maps.LatLng(<?php if ($_smarty_tpl->tpl_vars['winery']->value['Lat']) {
echo $_smarty_tpl->tpl_vars['winery']->value['Lat'];
} else { ?>0<?php }?>,<?php if ($_smarty_tpl->tpl_vars['winery']->value['Lon']) {
echo $_smarty_tpl->tpl_vars['winery']->value['Lon'];
} else { ?>0<?php }?>),
            zoom:5,
        };
        var upload_path = '<?php echo $_smarty_tpl->tpl_vars['system']->value['system_uploads'];?>
';
        var map = new google.maps.Map(document.getElementById("winery-map"),mapProp);
        var mapMark = {
            position: new google.maps.LatLng(<?php if ($_smarty_tpl->tpl_vars['winery']->value['Lat'] && $_smarty_tpl->tpl_vars['winery']->value['Lon']) {
echo $_smarty_tpl->tpl_vars['winery']->value['Lat'];?>
, <?php echo $_smarty_tpl->tpl_vars['winery']->value['Lon'];
} else { ?>0, 0<?php }?>),
            map: map,
...
<?php echo '</script'; ?>
>
<?php if ($_smarty_tpl->tpl_vars['related_wines']->value) {?>
                    ...
                    <div class="review-rating-filter-part">
                        <div data-testid="ratingFilter" class="review-rating-filter-container">
                            <div role="img" aria-label="Rated 5 stars" class="review-rating-filter-stars">
                                <img class="rating-icon" src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/includes/assets/js/plugins/rateit/star-gold32.png" alt="User rated star FullStar" style="height: 16px; width: 16px;">
                                <img class="rating-icon" src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/includes/assets/js/plugins/rateit/star-gold32.png" alt="User rated star FullStar" style="height: 16px; width: 16px;">
                                <img class="rating-icon" src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/includes/assets/js/plugins/rateit/star-gold32.png" alt="User rated star FullStar" style="height: 16px; width: 16px;">
...
/includes/assets/js/plugins/rateit/star-gold32.png" alt="User rated star FullStar" style="height: 16px; width: 16px;">
                ...
                <div class="review-rating-add-new">
                    <?php if ($_smarty_tpl->tpl_vars['has_review']->value) {?>
                    ...
                    <div class="review-rating-add-star">
                        <div role="img" aria-label="user image" class="review-rating-add-avatar">
                            ...
                            <div class="review-rating-add-avatar-avatar" style="background-image: url('<?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_picture']) {
echo $_smarty_tpl->tpl_vars['user']->value->_data['user_picture'];
} else { ?>//images.vivino.com/avatars/default_user_50x50.png')<?php }?>"></div>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered add-review-modal-dialog" role="document">
                        <div class="modal-content add-review-modal-content">
                            ...
                            <div class="modal-body add-review-modal-body">
                                <h5 class="add-review-modal-name">You're rating the <?php echo $_smarty_tpl->tpl_vars['details']->value['winery'];?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['details']->value['name'];?>
</h5>
                                <div class="review-rating-add-star">
                                    <div role="img" aria-label="user image" class="review-rating-add-avatar">
                                        <span data-testid="sentinel"></span>
                                        <div class="review-rating-add-avatar-avatar" style="background-image: url(<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_picture'];?>
);"></div>
                                    </div>
                                    <a type="button">
                            ...
                            <div class="modal-footer add-review-modal-footer">
                                <input name="title" value="<?php echo $_smarty_tpl->tpl_vars['details']->value['name'];?>
" hidden/>
                                <textarea name="text" style="display: none;">&lt;p&gt;&lt;a title=&quot;sssssssdf&quot; href=&quot;<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/detail/<?php echo $_smarty_tpl->tpl_vars['details']->value['Id_item'];?>
&quot;&gt;<?php echo $_smarty_tpl->tpl_vars['details']->value['name'];?>
&lt;/a&gt;&lt;/p&gt;</textarea>
                                <input type="hidden" class="js_x-image-input" name="cover" value="<?php echo $_smarty_tpl->tpl_vars['details']->value['image_URL'];?>
" hidden>
                                <input name="wine_id" value="<?php echo $_smarty_tpl->tpl_vars['details']->value['Id_item'];?>
" hidden/>
                                <select class="form-control" name="category" style="display: none;">
                                    <option value="23" selected>Wine</option>
                                </select>
                                <input class="form-control" name="tags" value="<?php echo $_smarty_tpl->tpl_vars['details']->value['winery'];?>
" hidden>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<!--<?php echo '<script'; ?>
 type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBRcUCMzgJ0gHoFv2D8A8DvtXj-gTLeFKQ&callback=initMap"><?php echo '</script'; ?>
>-->
