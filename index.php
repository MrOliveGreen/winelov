...
try {
	...
	if(!$user->_logged_in) {
        ...
        // get high rated 15 wines
        $high_rated = $user->get_wines('', '', '', '', '', '', '0', '500+', '1', 'high_rating', '15', '1');
        // get hightolow 15 wines
        $high_low = $user->get_wines('', '', '', '', '', '', '0', '500+', '1', 'hightolow', '15', '1');
        $high_france = $user->get_wines('', '', '', 'France', '', '', '0', '500+', '1', 'high_rating', '15', '1');
        
		/* assign variables */
        $smarty->assign('high_rated', $high_rated);
        $smarty->assign('high_low', $high_low);
        $smarty->assign('high_france', $high_france);
